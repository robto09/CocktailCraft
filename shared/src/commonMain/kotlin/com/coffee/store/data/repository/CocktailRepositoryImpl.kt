...
import com.coffee.store.domain.model.CocktailIngredient
...
class CocktailRepositoryImpl(
    ...
    private fun mapDtoToCocktail(dto: com.coffee.store.data.remote.CocktailDto): Cocktail {
        return Cocktail(
            id = dto.id,
            name = dto.name,
    ...
    private fun calculatePopularity(dto: com.coffee.store.data.remote.CocktailDto): Int {
